...
def parse_opts_offline():
    ...
    parser.add_argument(
        '--root_path',
        default='/home/archie/codes/gesture_recognition/classification/',
        #default='/root/data/ActivityNet',
        type=str,
        help='Root directory path of data')
    parser.add_argument(
        '--video_path',
        default='/home/archie/codes/gesture_recognition/dataset/jester/20bn-jester-v1/',
        type=str,
        help='Directory path of Videos')
    parser.add_argument(
        '--annotation_path',
        default='annotation_Jester/jester.json',
        type=str,
